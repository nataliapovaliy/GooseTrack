...
import { TaskToolbarStyled, TaskToolbarBtn } from './TaskToolbar.styled';
...
export const TaskToolbar = ({ task }) => {
    ...
    return (
        <>
            <TaskToolbarStyled>
                <TaskToolbarBtn onClick={toggleModal}>Edit</TaskToolbarBtn>
                <TaskToolbarBtn onClick={handleDeleteTask}>Del</TaskToolbarBtn>
            </TaskToolbarStyled>
            {/* {isModalOpen && (
